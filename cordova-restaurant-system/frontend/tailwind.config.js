  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'spatial-sm': '0 2px 8px -2px rgba(0, 0, 0, 0.05), 0 1px 4px -1px rgba(0, 0, 0, 0.03)',
        'spatial-md': '0 10px 25px -5px rgba(0, 0, 0, 0.06), 0 8px 10px -6px rgba(0, 0, 0, 0.04)',
        'spatial-lg': '0 20px 40px -10px rgba(0, 0, 0, 0.09), 0 1px 3px 0 rgba(0, 0, 0, 0.05)',
        'spatial-float': '0 24px 48px -12px rgba(27, 82, 50, 0.12), 0 12px 24px -8px rgba(0, 0, 0, 0.06)',
        'spatial-glow': '0 0 35px -5px rgba(27, 82, 50, 0.15)',
        'spatial-gold-glow': '0 0 35px -5px rgba(212, 160, 23, 0.20)',
      },
    },
  },
  plugins: [],
